...
class Test_Shipments():
    ...
    def test_update_endpoint(self):
        ...
        self.newShipment["updated_at"] = self.shipmentObject.get_timestamp().split('T')[0]
    ...
    def test_endpoint_restriction(self):
        ...
        responsePost_restricted = requests.post(f"{BASE_URL}/api/v1/shipments/", headers=headers_restricted, json=self.newShipment)
        responsePut_restricted = requests.put(f"{BASE_URL}/api/v1/shipments/{self.newShipment['id']}", headers=headers_restricted, json=self.newShipment)
        responseDelete_restricted = requests.delete(f"{BASE_URL}/api/v1/shipments/{self.newShipment['id']}", headers=headers_restricted)
        responseGet_restricted = requests.get(f"{BASE_URL}/api/v1/shipments/{self.newShipment['id']}", headers=headers_restricted)
